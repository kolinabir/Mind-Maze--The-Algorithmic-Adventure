...
class PlayState(GameState):
    ...
    def render(self, screen):
        if self.current_level:
            ...
            text = font.render(
                f'Level type "{level_name}" not implemented yet', True, (255, 255, 255)
            )
            ...
            sub_text = font.render(
                "Press ESC to return to level select", True, (255, 255, 255)
            )
    ...
    def change_state(self, state_name, transition="fade", **kwargs):
        ...
        if state_name in self.states:
            ...
            if self.current_state and not self.screen_manager.is_transitioning():
                ...
                self.screen_manager.start_transition(
                    current_surface, next_surface, transition
                )
            else:
