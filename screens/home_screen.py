...
from settings import (
    SCREEN_WIDTH, SCREEN_HEIGHT, WHITE, LIGHT_BLUE, 
    MENU_STATE, PLAY_STATE, SETTINGS_STATE, CREDITS_STATE,
    LEVEL_SELECT_STATE
)
...
class HomeScreen:
    ...
    def render(self, screen):
        ...
        # Draw subtitle
        subtitle_surface = self.subtitle_font.render(self.subtitle_text, True, LIGHT_BLUE)
        subtitle_rect = subtitle_surface.get_rect(center=(self.logo_pos[0], self.logo_pos[1] + 60))
