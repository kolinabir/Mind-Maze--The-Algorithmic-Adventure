...
class ParticleSystem:
    ...
    def add_particles(
        ...
        for _ in range(count):
            ...
            particle = Particle(
                pos_x, pos_y, color, vel_x, vel_y, size, life, gravity, fade, shape
            )
            self.particles.append(particle)
    ...
    def create_explosion(self, x, y, count=50, color=(255, 100, 20), size_range=(2, 5)):
        ...
        for _ in range(count):
            ...
            particle = Particle(
                pos_x, pos_y, color, vel_x, vel_y, size, life, 20, True, "circle"
            )
            self.particles.append(particle)
    ...
    def create_sparkle(self, x, y, count=20, color=(255, 255, 100)):
        ...
        for _ in range(count):
            ...
            particle = Particle(
                pos_x, pos_y, color, vel_x, vel_y, size, life, -5, True, "circle"
            )
            self.particles.append(particle)
